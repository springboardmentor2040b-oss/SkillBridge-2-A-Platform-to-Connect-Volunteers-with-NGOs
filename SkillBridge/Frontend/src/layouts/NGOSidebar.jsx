    ...
    <div style={{
      ...
      <div style={{ padding: "24px 20px", borderBottom: "1px solid #e5e7eb", marginBottom: "8px" }}>
        <h3 style={{
          ...
          {user.organizationName || "NGO Account"}
        </h3>
      </div>
      ...
      <div style={{
        ...
        <button data-path="/ngo-dashboard" style={btn("/ngo-dashboard")}
          onClick={() => navigate("/ngo-dashboard")}
          onMouseEnter={hover} onMouseLeave={unhover}>
          <LayoutDashboard size={18} /> Dashboard
        </button>

        <button data-path="/my-opportunities" style={btn("/my-opportunities")}
          onClick={() => navigate("/my-opportunities")}
          onMouseEnter={hover} onMouseLeave={unhover}>
          <Briefcase size={18} /> My Opportunities
        </button>

        <button data-path="/applicants" style={btn("/applicants")}
          onClick={() => navigate("/applicants")}
          onMouseEnter={hover} onMouseLeave={unhover}>
          <Users size={18} /> View Applicants
        </button>
        {user?.ngoRole === "admin" && (
        <button data-path="/ngo-team" style={btn("/ngo-team")}
        onClick={() => navigate("/ngo-team")}
        onMouseEnter={hover} onMouseLeave={unhover}>
        <Users size={18} /> Team Members
        </button>
        )}
        <button data-path="/ngo-profile" style={btn("/ngo-profile")}
          onClick={() => navigate("/ngo-profile")}
          onMouseEnter={hover} onMouseLeave={unhover}>
          <User size={18} /> Profile
        </button>

        {/* ✅ Fixed: NGO messages route */}
        <button data-path="/ngo-messages" style={btn("/ngo-messages")}
