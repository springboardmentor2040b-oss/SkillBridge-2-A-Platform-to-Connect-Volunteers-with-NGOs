...
import { Plus, Users, ClipboardList, Clock, LogOut, User as UserIcon, Check, X, MessageSquare, Bell, Shield } from 'lucide-react';
        ...
        const fetchDashboardData = async () => {
            try {
                ...
                setStats({
                    ...
                    applications: statsRes.data.pendingApps,
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6 mb-10">
                ...
                <Card className="border-l-4 border-purple-500">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <p className="text-sm font-medium text-slate-500 uppercase tracking-wider">Team Members</p>
                            <p className="text-2xl font-bold text-slate-800">{stats.teamMembers}</p>
                        </div>
                    </div>
                </Card>
            </div>
                ...
                <div>
                    ...
                    <Card title="Quick Actions" className="mt-8">
                        <div className="space-y-2">
                            ...
                            <Link to="/ngo-team" className="w-full text-left px-4 py-2 text-sm text-slate-700 hover:bg-slate-100 rounded transition flex items-center gap-2">
