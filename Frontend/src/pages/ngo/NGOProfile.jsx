...
import { Building2, Mail, MapPin, FileText, Globe, Edit2, Save } from "lucide-react";
...
export default function NgoProfile() {
  ...
  const fetch = async () => {
    try {
      ...
      setForm({
        name: res.data.organizationName || res.data.name,
  ...
  try {
    ...
    await api.put("/user/profile", {
      organizationName: form.name, // 🔥 IMPORTANT
              ...
              <div style={{ position: 'relative' }}>
                ...
                {isEditing ? (
                  <textarea
                    ...
                    onChange={handleChange}
                    placeholder="Describe your organization's mission, vision, and work"
                    rows="4"
                    style={{
                      width: '100%',
                      padding: '14px 14px 14px 45px',
