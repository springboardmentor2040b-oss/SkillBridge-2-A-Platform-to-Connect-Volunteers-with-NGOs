...
const Home = () => {
  ...
  return (
    <div className="min-h-screen bg-[#f5f7f6] text-sm">

      {/* NAVBAR */}
      <div className="flex justify-between items-center px-6 md:px-10 py-4 bg-white border-b">
        <div className="flex items-center gap-2">
          ...
          />
          <span className="text-2xl md:text-3xl font-semibold text-[#2F5373]">
            SkillBridge
          </span>
        </div>
      ...
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="flex flex-col items-center text-center mt-14">
          <h1 className="text-3xl md:text-4xl font-semibold text-[#2F5373] mb-4">
        ...
        <div className="flex justify-center mt-10">
          <div className="bg-white rounded-xl shadow-md flex flex-col md:flex-row w-full max-w-3xl overflow-hidden">

            <div className="flex-1 p-6 border-b md:border-b-0 md:border-r text-center">
              <img src="/search.jpeg" alt="Search" className="w-20 h-16 mb-3 mx-auto" />
            ...
            <div className="flex-1 p-6 text-center">
              <img src="/handshake.jpeg" alt="Handshake" className="w-20 h-16 mb-3 mx-auto" />
        ...
        <div className="flex flex-col md:flex-row justify-center mt-10 gap-4">
          <input
            ...
            className="w-full md:max-w-xl px-4 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-[#6CBBA2]"
          />
